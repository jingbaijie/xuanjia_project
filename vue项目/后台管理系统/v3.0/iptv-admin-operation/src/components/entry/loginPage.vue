...
export default {
  ...
  methods: {
    sendEmail() {
      axios
        .get("/emailCode/sendEmail?username=" + this.loginForm.username)
        .then(res => {});
    },
    languge() {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          axios
            .post(
              "auth/userlogin",
              `username=${this.loginForm.username}&password=${this.loginForm.password}&validateCode=${this.loginForm.validateCode}`,
              {
