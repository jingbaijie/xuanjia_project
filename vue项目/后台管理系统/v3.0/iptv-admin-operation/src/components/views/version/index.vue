      ...
      <el-table :data="tableData" :height="tableHeight" ref="multipleTable">
        ...
        <el-table-column prop="updateType" label="升级类型" width="120">
          <template slot-scope="scope">{{
            scope.row.updateType == 0 ? "固件升级" : "软件升级"
          }}</template>
        </el-table-column>
        <el-table-column prop="versionName" label="升级策略" width="120">
          <template slot-scope="scope">{{
            scope.row.updateStrategy == 0 ? "全部升级" : "部分升级"
          }}</template>
        </el-table-column>
        ...
        ></el-table-column>
        <el-table-column
          prop="softVersionCname"
          label="软件版本"
          width="120"
        ></el-table-column>
        <el-table-column
          prop="firmVersionCname"
          label="固件版本"
          width="120"
        ></el-table-column>
        <el-table-column
          prop="midVersionCname"
          label="中间件版本"
          width="120"
        ></el-table-column>
        <el-table-column
