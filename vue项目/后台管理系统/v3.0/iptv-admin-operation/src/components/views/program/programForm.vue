    ...
    >
      ...
      >
        ...
        >
          ...
          ></el-cascader>
          <!-- <el-select v-model="form.tagParentPath" multiple placeholder="请选择">
            <el-option
        ...
        >
          <el-input-number
            type="text"
            v-model="form.cartoonSumvideonum"
          ></el-input-number>
        </el-form-item>
        <el-form-item
          label="版权方"
          prop="cartoonProprietors"
          :label-width="formLabelWidth"
        >
        ...
        <el-form-item label="单集平均时长" :label-width="formLabelWidth">
          <el-input-number
            type="text"
            v-model="form.cartoonAveragetime"
          ></el-input-number>
        </el-form-item>
        <el-form-item label="总时长" :label-width="formLabelWidth">
          <el-input-number
            type="text"
            v-model="form.cartoonSumvideotime"
          ></el-input-number>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cartoonEname: [{ required: true, message: "必填项", trigger: "blur" }],
        cartoonProprietorsStarttime: [
          { required: true, message: "必填项", trigger: "change" }
        ],
        cartoonProprietorsEndtime: [
          { required: true, message: "必填项", trigger: "change" }
        ],
        cartoonSumvideonum: [
          { required: true, message: "必填项", trigger: "change" }
        ...
        isFree: [{ required: true, message: "必填项", trigger: "change" }],
        booleanUp: [{ required: true, message: "必填项", trigger: "change" }]
      },
      props: {
        multiple: true,
        lazy: true,
  ...
  methods: {
    ...
    editProgram(Classify) {
      ...
      Classify.iconPic
        ...
        : (this.iconPicUrl = defaultFocus);
      Classify.flagPic
        ? (this.flagPicUrl = this.imagesBaseUrl + Classify.flagPic.picPath)
        : (this.flagPicUrl = defaultFocus);
    },
    onSubmit(formName) {
      this.form.cspInfo = { id: this.form.cspInfo.id };
      if (this.form.tagParentPath)
        this.form.tagIds = Object.assign(this.form.tagParentPath, {});
      this.form.tagIds = this.form.tagIds && this.form.tagIds.join();
      // delete this.form.tagParentPath;
