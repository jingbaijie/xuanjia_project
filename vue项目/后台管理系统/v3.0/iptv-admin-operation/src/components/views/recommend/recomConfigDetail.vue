          ...
          >
            ...
            >
              ...
              <transition name="fade-transform" mode="out-in">
                <div class="balnce">
                  <image_choice
                    @getSelectImage="img => recomUploadSuccess(img, 0)"
                  ></image_choice>
                </div>
              </transition>
            </el-popover>
          ...
          >
            ...
            >
              ...
              <transition name="fade-transform" mode="out-in">
                <div class="balnce">
                  <image_choice
                    @getSelectImage="img => recomUploadSuccess(img, 1)"
                  ></image_choice>
                </div>
              </transition>
            </el-popover>
          ...
          >
            ...
            >
              ...
              <transition name="fade-transform" mode="out-in">
                <div class="balnce">
                  <image_choice
                    @getSelectImage="img => recomUploadSuccess(img, 4)"
                  ></image_choice>
                </div>
              </transition>
            </el-popover>
          ...
          >
            ...
            >
              <transition name="fade-transform" mode="out-in">
                <div class="balnce">
                  <image_choice
                    @getSelectImage="img => recomUploadSuccess(img, 2)"
                  ></image_choice>
                </div>
              </transition>
              <el-button slot="reference" size="small" type="primary" plain
...
export default {
  ...
  methods: {
    ...
    recomUploadSuccess(file1, type) {
      ...
      console.log(this.form.cornerList);
    },
