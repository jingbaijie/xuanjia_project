export default {
    ...
    recomTypeList_setter(state, value) {
        state.typeIds2.push(value);
    },
    dictionaryList_setter(state, value) {
        state.dictionaryList.push(value);
    },
    ...
    recommendList_clear(state) {
        state.recommendList = [];
    },
    specialList_setter(state, value) {
        state.specialList.push(value);
    },
    specialList_update(state, value) {
        state.specialList.splice(value.index, 1);
        state.specialList.push(value);
    },
    specialList_clear(state) {
        state.specialList = [];
    },
