  ...
  <div>
    <div class="img_list">
      <el-tabs
        ...
        type="border-card"
        @tab-click="tab=>{nodeClick(1,pageSize,tab)}"
      >
        <el-tab-pane
          :key="type.id"
        ...
        >
          <div style="btn_tab">
            ...
            <el-button
              ...
              :style="{'margin-left':'20px'}"
            >刪除图片</el-button>
            <el-input class="searchInput" style placeholder="通过名称或者MD5搜索图片" v-model="searchValue"></el-input>
          </div>
          <ul class="selectImg">
            <el-radio-group v-model="curImgIndex">
              <li :key="img.id" v-for="img in imgData">
                <el-card :body-style="{ padding: '8px',  cursor:'pointer' }" shadow="hover">
                  <img :id="img.id" :src="imagesBaseUrl+img.picPath" @click="showDetail(img)" />
