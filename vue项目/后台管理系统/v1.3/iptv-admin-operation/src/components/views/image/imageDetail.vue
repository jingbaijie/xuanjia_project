  ...
  <div>
    ...
    >
      <el-form :model="imgData">
        <el-form-item label="图片分类 :" :label-width="formLabelWidth">{{imgTypes[imgData.levelId]}}</el-form-item>
        <el-form-item label="图片名称 :" :label-width="formLabelWidth">
          <el-input v-model="imgData.picCname"></el-input>
        </el-form-item>
        <el-form-item label="图片MD5 :" :label-width="formLabelWidth">{{imgData.md5}}</el-form-item>
        <el-form-item label="上传时间 :" :label-width="formLabelWidth">{{imgData.createTime}}</el-form-item>
        <el-form-item label="图片路径 :" :label-width="formLabelWidth">{{imgData.picPath}}</el-form-item>
        <el-form-item
          label="图片尺寸 :"
          :label-width="formLabelWidth"
        >{{imgData.picW+' x '+imgData.picH}}</el-form-item>
