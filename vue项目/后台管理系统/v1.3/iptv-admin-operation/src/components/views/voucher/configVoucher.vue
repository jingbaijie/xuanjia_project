  ...
  <div>
    ...
    >
      <el-form :model="form" ref="form" :rules="rules">
        <el-form-item label="卡号位数" prop="cardNumLength" :label-width="formLabelWidth">
        ...
        <el-form-item label="生成数量" prop="genNumber" :label-width="formLabelWidth">
          <!-- <el-input type="text" v-model="form.genNumber"></el-input> -->
          <el-input-number v-model="form.genNumber" :min="1" :max="5000" label="生成数量"></el-input-number>
        </el-form-item>
  ...
  methods: {
    ...
    handleCreate(form) {
      let param = {
        ...
        isRestrictUser: form.isMixedPassword,
