  ...
  <div>
    ...
    >
      <el-form :model="form" ref="form" :rules="rules">
        <el-form-item label="匹配规则 :" prop="matchRule" :label-width="formLabelWidth">
        ...
        <el-form-item label="匹配范围 :" prop="matchRange" :label-width="formLabelWidth">
        ...
        <el-form-item label="匹配图库类型 :" prop="matchRange" :label-width="formLabelWidth">
          <el-radio-group v-model="form.levelId" @change="sourceRange()">
            <el-radio label="iconPicW">详情页</el-radio>
            <el-radio label="labelPicW">标签图</el-radio>
            <el-radio label="detailPicW">详情卡通图</el-radio>
          </el-radio-group>
        </el-form-item>
