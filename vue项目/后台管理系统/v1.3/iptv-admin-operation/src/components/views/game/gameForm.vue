  ...
  <div>
    ...
    >
      <el-form :model="form" ref="form" :rules="rules"  style="max-height:500px;overflow-y:auto">
        ...
        <el-form-item label="游戏名称" prop="gameCname" :label-width="formLabelWidth">
        ...
        <el-form-item label="游戏介绍" :label-width="formLabelWidth">
          <el-input v-model="form.gameIntrolduction" type="textarea" :rows="2" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="jad地址" :label-width="formLabelWidth">
          <!-- <el-input type="text" v-model="form.jadFile"></el-input> -->
          <el-upload
            :action="api+'/sysadmin/content/game/uploadGamesFile'"
            :headers="{'x-a-t':this.token}"
        ...
        <el-form-item label="免费状态" :label-width="formLabelWidth">
