  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-form :model="form" ref="form" :rules="rules">
        <el-form-item v-if="form.id" label="页面ID" prop="id" :label-width="formLabelWidth">
          <el-input v-model="form.id" :disabled="true" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="一级页面" prop="pageFlag" :label-width="formLabelWidth">
        ...
        <el-form-item label="页面中文名" prop="pageCname" :label-width="formLabelWidth">
          <el-input v-model="form.pageCname" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="页面英文名" prop="pageEname" :label-width="formLabelWidth">
          <el-input v-model="form.pageEname" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="上一级页面" prop="prePage" :label-width="formLabelWidth">
        ...
        <el-form-item label="页面背景图" prop="pageBigpicUrl" :label-width="formLabelWidth">
          <el-popover placement="right" width="535" trigger="hover">
            <el-input v-model="form.pageBigpicUrl" :style="{display:'none'}" autocomplete="off"></el-input>
            <el-button slot="reference" @click="clearImg" type="warning" plain>选 择</el-button>
