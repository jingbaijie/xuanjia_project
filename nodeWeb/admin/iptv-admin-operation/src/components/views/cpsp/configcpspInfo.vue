<template>
  <div>
    ...
    >
      <el-form :model="cpspConfigForm" ref="cpspConfigForm" :rules="rules"  style="max-height:500px;overflow-y:auto">
        <el-form-item label="名称" prop="cpCname" :label-width="formLabelWidth">
          <el-input type="text" v-model="cpspConfigForm.cpCname"></el-input>
        </el-form-item>
        <el-form-item label="类型" prop="booleanUp" :label-width="formLabelWidth">
          <el-radio v-model="cpspConfigForm.booleanUp" label="0">cp</el-radio>
          <el-radio v-model="cpspConfigForm.booleanUp" label="1">sp</el-radio>
        </el-form-item>
        <el-form-item label="英文名称" prop="cpEname" :label-width="formLabelWidth">
          <el-input type="text" v-model="cpspConfigForm.cpEname"></el-input>
        </el-form-item>
        <el-form-item label="cpCode" prop="cpCode" :label-width="formLabelWidth">
        ...
        <el-form-item label="说明" prop="cpIntroduction" :label-width="formLabelWidth">
          <el-input type="text" v-model="cpspConfigForm.cpIntroduction"></el-input>
        </el-form-item>
        <el-form-item label="cpPhone" prop="cpPhone" :label-width="formLabelWidth">
          <el-input type="text" v-model="cpspConfigForm.cpPhone"></el-input>
        </el-form-item>
        <el-form-item label="cpProductName" prop="cpProductName" :label-width="formLabelWidth">
          <el-input type="text" v-model="cpspConfigForm.cpProductName"></el-input>
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input type="text" v-model="cpspConfigForm.cpProductAddress"></el-input>
        </el-form-item>

        <el-form-item label="cpUptime" prop="cpUptime" :label-width="formLabelWidth">
          <el-input type="text" v-model="cpspConfigForm.cpUptime"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="onSubmit('cpspConfigForm')">提 交</el-button>
      </div>
    </el-dialog>
  </div>
</template>
