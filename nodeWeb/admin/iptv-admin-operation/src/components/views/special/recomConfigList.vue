      ...
      <el-form :model="form" style="max-height:600px;overflow-y:auto">
        <div class="recom_item" :key="'a' + index" v-for="(recoms, index) in recommendList">
          ...
          <el-form-item label="上" label-width="20px" style="float:left">
            <el-input-number v-model="recoms.movetop" :min="0" controls-position="right"></el-input-number>
          </el-form-item>
          <el-form-item label="下" label-width="20px" style="float:left">
            <el-input-number v-model="recoms.movedown" controls-position="right" :min="0"></el-input-number>
          </el-form-item>
          <el-form-item label="左" label-width="20px" style="float:left">
            <el-input-number v-model="recoms.moveleft" :min="0" controls-position="right"></el-input-number>
          </el-form-item>
          <el-form-item label="右" label-width="20px" style="float:left">
            <el-input-number v-model="recoms.moveright" controls-position="right" :min="0"></el-input-number>
          </el-form-item>
          ...
          <div :key="'e' + x" v-for="(corner, x) in recoms.cornerList" :style="{ clear: 'both' }">
