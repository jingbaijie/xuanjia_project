  ...
  <div>
    <div class="btn_area">
      <div class="add_btn">
        ...
        <dateSearch @searchTime="getSearchTime" :fatherMethod="getActiveList"></dateSearch>
        <el-button
    ...
    >
      ...
      <el-table-column prop="activityEndTime" label="结束时间"></el-table-column>
      <el-table-column prop="commSpecialEname" label="专项链接"></el-table-column>
      <el-table-column prop="booleanUp" label="状态" width="100">
        <template slot-scope="scope">{{booleanUp[scope.row.booleanUp]}}</template>
      </el-table-column>
