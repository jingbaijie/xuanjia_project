...
function District(obj){
    ...
    this.imgUrl = obj.imgUrl ? AjaxConfig.imgUrl + obj.imgUrl : '../imgs/focus2.png';     // 焦点地址
...
District.prototype = {
    ...
    generateContainer: function () {
        ...
        for(var i = 0; i < this.rowNum; i++){    // 行
            for(var j = 0; j < this.step; j++){  // 列
                ...
                var dom = '<div class="wrapper">' +
                               '<div class="recommend" id="recommend' + (this.step * i + j) + '" style="position: absolute;background: url(../imgs/empty.png) no-repeat;background-size: contain ;top:' +
                               ...
                               this.domWidth + 'px;">' +
                                    str +
                                   '<div id="freeBadge' + (this.step * i + j) + '" style="top: 0;left: 0; width: 59px; height: 30px;background: url(../imgs/freeBadge.png);visibility: hidden;"></div>' +
                                   '<div id="vipBadge' + (this.step * i + j) + '" style="position: absolute;top: 0;right: 0; width: 52px; height: 53px;background: url(../imgs/vipBadge.png);visibility: hidden;"></div>' +
                               '</div>' +
                               '<div id="hands_x0_y0_recommendFocus' + (this.step * i + j) + '_" class = "recommendFocus" style="position:absolute;z-index: 1;top:' +
                                   (this.domTop + (this.domHeight + this.intervalD)*i - 10) + 'px;left:' +
                                   (this.domLeft + (this.domWidth + this.intervalR)*j - 10) + 'px;height:' +
                                   this.domHeight + 'px;width:' +
                                   this.domWidth + 'px;">' +
        ...
        // 生成箭头
        if(this.showArrow){
            var arrow = '<div id="down" class="arrow" style="position: absolute;z-index: 2;visibility: hidden;background:url(../imgs/down.png) no-repeat;top:' +
    ...
    arrowChange: function(){
        ...
        _this.timer = setTimeout(function(){
            CT.$('down').src = '../imgs/arrowDown' + _this.arrowCount + '.png';
            _this.arrowCount++;
    ...
    clearData: function () {
        for(var i = 0; i < this.rowNum * this.step; i++){
            ...
            recommend.style.background = "url(../imgs/empty.png)";
            if(this.showTitle){
