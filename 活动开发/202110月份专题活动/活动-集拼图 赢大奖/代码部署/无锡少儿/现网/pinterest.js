...
var page = {
    ...
    getChanceFunc: function () {
        ...
        chance.getChance(xjDataLog.getUserId(), 36, function (getActi1Res) {
            if (getActi1Res.data.activityChance >= 1) {
                chance.getChance(xjDataLog.getUserId(), 35, function (getActi2Res) {
                    if (getActi2Res.data.activityChance >= 1) {
                        return;
                    } else {
                        chance.setChance(xjDataLog.getUserId(), 35, function (setActi2Res) {
                ...
                chance.setChance(xjDataLog.getUserId(), 36, function (setActi1Res) {
                    CT.getActivityUrl(36);
                });
            }
        });
      },
