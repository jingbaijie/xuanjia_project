...
//新增活动埋点日志，烦请活动开发者在活动内跳转活动时调用actiCommonJumpUrl进行跳转，防止埋点日志出现偏差
// setLoggerInfo.pageInfoLog = {
//     "pageInfo": {
//         "commonPageId": CT.requestValue("activityId"),
//         "commPageCname": CT.requestValue("contentCName"),
//         "commPageEname": CT.requestValue("contentEName")
//     }
// }
/*****************************活动需要的基本数据**************************/
//用户名
...
var actiObj = (function(){
    ...
    Acti.prototype = {
        ...
        getMyChance: function(specialUserId,actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
                requestUrl: _this.getChanceUrl,
                params: {
        ...
        setMyChance: function(specialUserId,actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
                requestUrl: _this.setChanceUrl,
                params: {
        ...
        getUserDataList: function(fn){
            var _this = this;
            // interface.loggerInfo("获取弹窗信息",'post');
            this.getAjaxResult({
        ...
        setUserDataList: function(userData,fn){
            var _this = this;
            // interface.loggerInfo("弹窗结果：",'post');
            this.getAjaxResult({
        ...
        /**
         * njxj_sale_card_tab
         * 获取活动会员体验券激活码(只针对真实用户有效)
         * 请求参数: searchValue:actiActivityId
         * 返回信息
         * 请求成功
         * {
                data: activeDate: null
                    cardNo: "2964430089944040"//未发放过的激活码
                    cardPassword: null//密码，活动默认不设置
                    createTime: "2021-05-17 15:52:44"
                    effectiveEndTime: "2023-05-31 00:00:00"//体验券生效时间
                    effectiveStartTime: "2021-05-17 00:00:00"//体验券兑换截止时间
                    endTime: null
                    id: 120
                    ip: null
                    mac: null
         ...
         *
         */
        getVipExperCodeUrl: actiActionUrl + "voucher/getEffectiveCode",
        /**
         * 获取活动会员体验券激活码
         */
        getVipExperCode: function (fn) {
            var _this = this;
            this.getAjaxResult({
                requestUrl: _this.getVipExperCodeUrl,
                params: {
                    searchValue: actiActivityId
                },
                success: function (data) {
                    fn && fn(data);
                },
        ...
        /**
         * 激活会员体验券
         * @param cardNo 获取到的体验券激活码
         * @param userId 仅限真实用户
         */
        setVipExperCodeUrl: actiActionUrl + "voucher/verify",
        setVipExperCode: function (cardNo,fn) {
            var _this = this;
            this.getAjaxResult({
                requestUrl: _this.setVipExperCodeUrl,
                params: {
                    cardNo: cardNo,
                    userId:actiUserId
                },
        ...
        actiCommonJumpUrl: function(url){
            ...
            */
            ...
            strArr["contentCName"] = CT.requestValue("contentCName");
            strArr["contentId"] = CT.requestValue("contentId");
            strArr["contentEName"] = CT.requestValue("contentEName");
