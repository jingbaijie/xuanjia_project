    ...
    **/
    choosePrize: function (index) {
        ...
        setTimeout(function () {
            ...
            // 上传领取的奖品
            setPrizeContent({ contentId: actiActivityId, userId: actiUserId, prizeId: _this.prizeId }, function (setRes) {
                if (setRes.errorCode == 1000) {
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            // 跳转集碎片页面
                            actiObj.actiCommonJumpUrl("collectJigsaw&winPrizeGame.html?isOrder=" + isOrder + "&prizeIndex=" + collectJigSawMainEG.prize3Random + "&restart=1");
                        }, 1500);
                    }, 1500);
                }
            });
