...
var page = {
    ...
    getChanceFunc: function () {
        ...
        chance.getChance(xjDataLog.getUserId(), 204, function (getActi1Res) {
            if (getActi1Res.data.activityChance >= 1) {
                chance.getChance(xjDataLog.getUserId(), 202, function (getActi2Res) {
                    if (getActi2Res.data.activityChance >= 1) {
                        return;
                    } else {
                        chance.setChance(xjDataLog.getUserId(), 202, function (setActi2Res) {
                ...
                chance.setChance(xjDataLog.getUserId(), 204, function (setActi1Res) {
                    CT.getActivityUrl(204);
                });
            }
        });
      },
