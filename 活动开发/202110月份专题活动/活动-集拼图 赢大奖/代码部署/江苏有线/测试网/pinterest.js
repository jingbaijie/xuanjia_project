...
var page = {
    ...
    getChanceFunc: function () {
        ...
        chance.getChance(parseInt(xjDataLog.getUserId()), 27, function (getActi1Res) {
            if (getActi1Res.data.activityChance >= 1) {
                chance.getChance(parseInt(xjDataLog.getUserId()), 26, function (getActi2Res) {
                    if (getActi2Res.data.activityChance >= 1) {
                        return;
                    } else {
                        chance.setChance(parseInt(xjDataLog.getUserId()), 26, function (setActi2Res) {
                ...
                chance.setChance(parseInt(xjDataLog.getUserId()), 27, function (setActi1Res) {
                    CT.getActivityUrl(27);
                });
            }
        });
    },
