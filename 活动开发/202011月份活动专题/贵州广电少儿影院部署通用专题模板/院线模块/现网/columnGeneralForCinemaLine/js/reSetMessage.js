...
function PageJson(OutJson){
    ...
    this.updateMes = function(data,allMsg){
        if(data.recommend_1){
            allMsg.recommendMsg = this.getNumsRecMsg(data.recommend_1);
        }
        if(data.recommend_2){
            allMsg.outRecommendMsg = this.getNumsRecMsg(data.recommend_2);
        }
        if(data.recommend_3){
            allMsg.otherDetailMsg = this.getNumsRecMsg(data.recommend_3);
        }
        return allMsg;
    };
    /**
