...
function keyDownEvent1(evt) {
    ...
    /*var keyName = getKeyCodeName(keyCode);
     document.getElementById('testDiv1').innerHTML = keyName;*/
    var testDiv = document.getElementById("testDiv");
    if (testDiv) {
        testDiv.style.height = "700px";
        testDiv.innerHTML += "当前键值为-----" + keyName + "<br>";
    }
    ...
    switch (keyName) {
        ...
        case "OUT_PAGE":
            evt = evt != null && evt != undefined ? evt : window.event;
            evt.preventDefault();
            var channelUrl = CT.getCookie("channelUrl") || "ui:///globalEvent.htm";
            iPanel.mainFrame.location = channelUrl;
            break;
        case "VolumeUp":
