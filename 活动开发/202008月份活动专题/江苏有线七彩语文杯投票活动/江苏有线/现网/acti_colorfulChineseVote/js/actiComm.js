...
var actiActionUrl = "http://172.31.231.229:28080/iptv-web-api/api";
// var actiActionUrl = "http://112.25.69.77:8191/xjcartoon_activity_BtopInterface";//河北联通测试网
var actiObj = (function(){
    ...
    Acti.prototype = {
         ...
         * });
         */
        getChance: function(actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
         ...
         * })
         */
        setChance: function(actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
         ...
         * })
         */
        getActivityPrize: function(actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
         ...
         * })
         */
        setPrize: function(actiActivityId,prizeId,fn){
            var _this = this;
            this.getAjaxResult({
         ...
         * })
         */
        getUserPrizeInfo: function(actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
         ...
         * })
         */
        getPrizeUserInfo: function(actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
         ...
         * })
         */
        getUserDataList: function(actiActivityId,fn){
            var _this = this;
            this.getAjaxResult({
         ...
         * })
         */
        setUserDataList: function(actiActivityId,userData,fn){
            var _this = this;
            this.getAjaxResult({
        ...
        actiCommonJumpUrl: function(url){
            ...
            */
            ...
            strArr["defaultFocus"] = CT.requestValue("contentEName");//从A页面离开到达活动页面，defaultFocus记录A页面离开时的焦点，实现来哪去哪（备用）
			strArr["actiTime"] = new Date().getTime();
