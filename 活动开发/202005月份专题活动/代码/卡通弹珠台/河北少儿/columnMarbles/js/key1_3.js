...
document.onkeydown = keyDownEvent1; //按键按下
//document.onkeyup = keyUpEvent1; //按键抬起
//function keyUpEvent1(evt) {
//	var keyCode1 = CT.keyCode(evt);
//	var keyName = getKeyCodeName(keyCode1);
//	CT.writeInfo("抬起事件----keyName="+keyName+"------curFocus.FocusID="+curFocus.FocusID);
//	if(keyName == "OK" && curFocus.FocusID == "hands_x0_y0_marblesFocus_") {
//		CT.writeInfo("OK键抬起---keyName="+keyName+"------curFocus.FocusID="+curFocus.FocusID);
//		MarblesGame.keyUpFunc(evt);
//	}
//}
...
function keyDownEvent1(evt) {
	...
	switch(keyName) {
		...
		case "RIGHT":
			...
			break;
		case "OK":
//			if(curFocus.FocusID == "hands_x0_y0_marblesFocus_") {
//				MarblesGame.keyDownFunc(evt);
				//CT.writeInfo("在按钮焦点上----keyName="+keyName+"------curFocus.FocusID="+curFocus.FocusID);
//			} else if(curFocus.FocusID == "hands_x0_y0_blankFocus_") {
//				MarblesGame.changeFocus("hands_x0_y0_marblesFocus_");
				//CT.writeInfo("在空白焦点上----keyName="+keyName+"------curFocus.FocusID="+curFocus.FocusID);
			//} else {
				curFocus.OK();
			//}
			break;
