function GeneralColumn() {
    ...
    this.init = function () {
        ...
        if (!this.haveEmpty) {
            this.haveEmpty = true;
            if (CT.getCookie("columnBackFocus" + pageMsgArr[curPageNum].pageInfo.commonPageId)) {
                this.curPageFocusName = CT.getCookie("columnBackFocus" + pageMsgArr[curPageNum].pageInfo.commonPageId);
