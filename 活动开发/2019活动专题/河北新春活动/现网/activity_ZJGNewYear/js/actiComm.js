...
//活动接口项目名
var actiActionUrl = activityUrl+"xjcartoon_activity_BtopInterface";
var actiObj = (function(){
    function Acti(){
        this.getOrderTimeUrl = IP + ":8090/xjcartoon_BtopInterface_xuanli/expand/getOrderTimeByuserId";
    };
    /**
     * 活动接口
    ...
    Acti.prototype = {
         ...
         * {
                result: "0",
                message: "2019-12-09 07:41:51.0"
            }
         *
         *
         */
        getOrderTime: function(fn){
            var _this = this;
            this.getAjaxResult({
                requestUrl: _this.getOrderTimeUrl,
                params: {
                    userId: actiUserId
                },
                success: function(data){
